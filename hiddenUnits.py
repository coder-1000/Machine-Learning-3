...
HIDDEN_UNIT_OPTIONS = [100, 500, 1000]
...
if __name__ == "__main__":
    ...
    for lr in range(numOptions):
        ...
        print("hidden units  = " + str(HIDDEN_UNIT_OPTIONS[lr]))
        ...
        plt.ylabel('Loss');
        plt.legend();
        plt.title("Cross Entropy Loss vs Num Epochs with HU = " + str(HIDDEN_UNIT_OPTIONS[lr]) )
        ...
        plt.legend();
        plt.title("Classification Error vs Num Epochs with HU = " + str(HIDDEN_UNIT_OPTIONS[lr]))
